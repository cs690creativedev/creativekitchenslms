...
*/
        ...
        public ActionResult StateTax(int? page, string search = null, string Type = null, string Type1 = null, string Start = null, string end = null, string msg = null)
        {
            ...
            try
            {
                ...
                var result = db.taxes.Where(l => (l.state == Type) && (l.tax_anme == "State Tax") && l.state == Type).ToList();
        ...
        */
        public ActionResult CityTax(int? page, string search = null, string Type = null, string Type1 = null, string Start = null, string end = null, string msg = null)
        {
            ...
            try
            {
                ...
                var result = db.taxes.Where(l => (l.state == Type) && (l.city == Type1||l.city=="") && (l.tax_anme == "City Tax" || l.tax_anme=="") && l.state == Type).ToList();
        ...
        public ActionResult BOTax(int? page, string search = null, string Type = null, string Type1 = null, string Start = null, string end = null, string msg = null)
        {
            ...
            try
            {
                ...
                ViewBag.lead_type_city = ClassInfo1;
                var result = db.taxes.Where(l => (l.state == Type) && (l.city == Type1 || l.city == "") && (l.tax_anme == "B&O Tax" || l.tax_anme == "") && l.state == Type).ToList();
...
*/
        ...
        public ActionResult LaborCost(int? page, string search = null, string Type = null, string Start = null, string end = null, string msg = null)
        {
            DateTime start = string.IsNullOrEmpty(Start) ? DateTime.MinValue : DateTime.Parse(Start);
            DateTime end2 = string.IsNullOrEmpty(end) ? DateTime.MaxValue : DateTime.Parse(end);
            TimeSpan ts = new TimeSpan(23, 59, 59);
