...
namespace ck_project.Helpers
{
    public class GeneralHelper
    {
        ...
        {
            var buildingPermit = db.building_permit.Where(b => b.deleted == false && b.start_date <= date && b.end_date >= date && b.start_range <= buildingPermitCost && b.end_range >= buildingPermitCost).FirstOrDefault();
